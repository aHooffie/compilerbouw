...
extern node    *FREEexpressions(node * arg_node, info * arg_info);
extern node    *FREEfloat(node * arg_node, info * arg_info);
extern node    *FREEfor(node * arg_node, info * arg_info);
extern node    *FREEfunc(node * arg_node, info * arg_info);
extern node    *FREEfuncbody(node * arg_node, info * arg_info);
extern node    *FREEfunctioncallexpr(node * arg_node, info * arg_info);
extern node    *FREEfunctioncallstmt(node * arg_node, info * arg_info);
...
extern node    *FREEparameters(node * arg_node, info * arg_info);
