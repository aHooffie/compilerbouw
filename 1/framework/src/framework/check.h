...
extern node    *CHKexpressions(node * arg_node, info * arg_info);
extern node    *CHKfloat(node * arg_node, info * arg_info);
extern node    *CHKfor(node * arg_node, info * arg_info);
extern node    *CHKfunc(node * arg_node, info * arg_info);
extern node    *CHKfuncbody(node * arg_node, info * arg_info);
extern node    *CHKfunctioncallexpr(node * arg_node, info * arg_info);
extern node    *CHKfunctioncallstmt(node * arg_node, info * arg_info);
...
extern node    *CHKparameters(node * arg_node, info * arg_info);
